    ...
    <div class="footer_priv">
        ...
        <div class="container">
            ...
            <ul class="list_menu_footer">
                ...
                <li class="{{ Request::segment(1) === 'registration' ? 'current' : null }}"><a href="{{ route('registration.index') }}"><a href="{{ route('registration.index') }}">Registration Form<strong></strong></a></li>
                <li class="{{ Request::segment(1) === 'sponsorship' ? 'current' : null }}"><a href="{{ route('sponsorship.index') }}">Sponsorship<strong></strong></a></li>
                <li><a href="{{ route('sponsorship.index') }}">Promotion<strong></strong></a></li>
            </ul>
        </div>
