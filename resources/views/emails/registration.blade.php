...
<html lang="en">
<head>
    <title>Conference Registration Email</title>
    <meta charset="UTF-8">
    <meta name="viewport"
...
<div>
    ...
    <p>
        <strong>DOLLAR CURRENT ACCOUNT (International Attendees)</strong> <br>
        Account Name: PHILIPPINE SOCIETY FOR COSMETIC SCIENCE INC. <br>
    ...
    <p>
        Kindly send the proof of payment to secretariat@ascs2025.com
    </p>
    ...
    <p>
        Looking forward to welcome you at the 17th ASCS Conference, Manila 2025. 
    </p>

    <p>
        This is an autoreply. <br>
        For any other inquiries/clarifications, please email us at secretariat@ascs2025.com
    </p>

    <p class="signature">
        Warm Regards, <br><br>
        ASCS 2025 Secretariat <br>
